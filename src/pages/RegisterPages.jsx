                ...
                <div className="sm:w-[456px] sm:h-[80%]">
                    <div className="mx-w-md mx-auto p-12">  
                        ...
                        <form>
                            ...
                            <input type="text" id="regUser" placeholder="Enter Username" className="bg-gray-100 w-full border rounded py-2 px-4 text-sm" value={users} onChange={onChangeUser} />

                            <div className="px-4 pt-4 pb-2 text-xs">Password</div>
                            <input type="password" id="regPass" placeholder="Enter Password" className="lg:mt-0 bg-gray-100 w-full border rounded py-2 px-4 text-sm" value={password} onChange={onChangePass}/>

                            <div className="px-4 pt-4 pb-2 text-xs">Confirm Password</div>
                            <input type="password" id="regConf" placeholder="Confirm Password" className="lg:mt-0 bg-gray-100 w-full border rounded py-2 px-4 text-sm" value={confirm} onChange={onChangeConfirm} />
